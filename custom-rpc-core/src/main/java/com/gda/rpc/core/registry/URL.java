...
public class URL {
    ...
    //注册到节点的服务的全类名 com.xxx.XxxService
    ...
    public boolean equals(Object obj) {
        ...
        URL url = (URL) obj;
        return Objects.equals(applicationName, url.getApplicationName())
                && Objects.equals(serviceName, url.getServiceName());
    }
    ...
    /**
     * 将有个节点下的信息转换为一个provider节点对象
     * 例如：hb-rpc;com.xxx.XxxService;192.168.211.133:9093;7881569123;100;default
     */
